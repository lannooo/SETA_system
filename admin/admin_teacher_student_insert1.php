...
<?php
    ...
    {
        echo "Error: ".$_FILES["file"]["error"]."<br/>;window.location.href='admin_teacher_detail.php?id1=$tid';</script>";
    }
    ...
    echo "<script language='javascript'>alert('添加学生成功');window.location.href='admin_teacher_detail.php?id1=$tid';</script>";
?>