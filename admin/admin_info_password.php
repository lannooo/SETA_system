    ...
    <div class="container">
        ...
        <div class="row clearfix">
            <div class="col-md-4 column">
                <form method="post" action="admin_info_modify1.php" role="form">
                    <div class="form-group"><label>请输入旧密码</label><input type="password" class="form-control" name="old_password" /></div>
                    <div class="form-group"><label>请输入新密码</label><input type="password" class="form-control" name="new_password1" /></div>
                    <div class="form-group"><label>请确认新密码</label><input type="password" class="form-control" name="new_password2" /></div>
