...
<body>
    <?php
        ...
        $sql="select aid,username,name,phone,email from admin";
                ...
                echo "<div class='row clearfix'>";
                    echo "<div class='col-md-12 column'>";
                        ...
                        if($result->num_rows>0){
                            ...
                            echo "<tr><td>编号</td><td>用户名</td><td>姓名</td><td>电话</td><td>邮箱</td><td>操作</td></tr>";
                            while($row =$result->fetch_array()){
                                ...
                                echo "<td>$row[3]</td>";
                                echo "<td>$row[4]</td>";
                                echo "<td><a href='admin_info_password.php'>修改密码</a> <a href='admin_info_modify.php'>修改个人信息</a></td>";
                                echo "</tr>";
                            }
                            echo "</table>";
                        }
