...
<body>
        ...
        $sql="select clid,coname,name,cltime,place,student_num from class natural join course join teacher where class.tid=teacher.tid and coid='{$coid}'";
                ...
                echo "<div class='row clearfix'>";
                    echo "<div class='col-md-12 column'>";
                        ...
                        echo "<div class='jumbotron'>";
                            echo "<h1>管理员，您好!</h1>";
                            echo "<p>软件工程课程教学辅助系统</p>";
                        echo "</div>";

                        echo "<div class='panel-group' id='panel-60398'>";
                            echo "<div class='panel panel-default'>";
                                echo "<div class='panel-heading'>";
                                    echo "<a class='panel-title' data-toggle='collapse' data-parent='#panel-60398' href='#panel-element-447696'>查看班级</a>";
                                echo "</div>";
                                    ...
                                    echo "<div class='panel-body'>";
                                        if($result->num_rows>0){
                                            ...
                                            while($row =$result->fetch_array()){
                                                ...
                                                echo "<td>$row[4]</td>";
                                                echo "<td>$row[5]</td>";
                                                echo "<td><a href='admin_course_student_insert.php?id1=$coid&id2=$row[0]'>导入选课名单</a> <a href='admin_course_class_delete.php?id1=$coid&id2=$row[0]'>删除</a></td>";
                                                echo "</tr>";
                                                $i++;
                                            }
                                            echo "</table>";
        ...
        $sql="select textbook,coname_en,pre_learning,plan,background,assessment,project_info from course where coid='{$coid}'";
        ...
        if(!$result){
            ...
            echo "<div class='panel panel-default'>";
                echo "<div class='panel-heading'>";
                    echo "<a class='panel-title' data-toggle='collapse' data-parent='#panel-60398' href='#panel-element-983376'>查看详情</a>";
                echo "</div>";
                echo "<div id='panel-element-983376' class='panel-collapse collapse'>";
                    echo "<div class='panel-body'>";
                        if($result->num_rows>0){
                            echo "<table class='table table-hover'>";
                            while($row =$result->fetch_array()){
                                echo "<tr><td>教材</td><td>$row[0]</td></tr>";
                                echo "<tr><td>英文名称</td><td>$row[1]</td></tr>";
                                echo "<tr><td>预修要求</td><td>$row[2]</td></tr>";
                                echo "<tr><td>教学计划</td><td>$row[3]</td></tr>";
                                echo "<tr><td>课程背景</td><td>$row[4]</td></tr>";
                                echo "<tr><td>课程评价</td><td>$row[5]</td></tr>";
                                echo "<tr><td>作业信息</td><td>$row[6]</td></tr>";
                            }
                            echo "</table>";
                        }
                    echo "</div>";
            ...
            echo "<div class='panel panel-default'>";
                echo "<div class='panel-heading'>";
                    echo "<a class='panel-title' data-toggle='collapse' data-parent='#panel-60398' href='#panel-element-233333'>添加班级</a>";
                echo "</div>";
                echo "<div id='panel-element-233333' class='panel-collapse collapse'>";
                    echo "<div class='panel-body'>";
                                echo "<div class='row clearfix'>";
                                    echo "<div class='col-md-4 column'>";
                                        echo "<form method='post' action='admin_course_class_insert.php' role='form'>";
                                            echo "<div class='form-group'><label>教师姓名</label><input type='text' class='form-control' name='name' /></div>";
                                            echo "<div class='form-group'><label>上课时间</label><input type='text' class='form-control' name='cltime' /></div>";
                                            echo "<div class='form-group'><label>上课地点</label><input type='text' class='form-control' name='place' /></div>";
                                            echo "<div class='form-group'><label>教室容量</label><input type='text' class='form-control' name='student_num' /></div>";
