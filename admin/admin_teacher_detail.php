...
<body>
        ...
        $sql="select clid,coname,name,cltime,place,student_num from class natural join course join teacher where class.tid=teacher.tid and teacher.tid='{$tid}'";
                                ...
                                echo "<div id='panel-element-447696' class='panel-collapse collapse in'>";
                                    echo "<div class='panel-body'>";
                                        if($result->num_rows>0){
                                            ...
                                            echo "<tr style='background-color:rgba(255,255,255,0.3)'><td>编号</td><td>课程名称</td><td>教师姓名</td><td>上课时间</td><td>上课地点</td><td>教室容量</td><td>操作</td></tr>";
                                            $i=1;
                                            while($row =$result->fetch_array()){
                                                ...
                                                echo "<td>$row[4]</td>";
                                                echo "<td>$row[5]</td>";
                                                echo "<td><a href='admin_teacher_student_insert.php?id1=$tid&id2=$row[0]'>导入选课名单</a> <a href='admin_teacher_class_delete.php?id1=$tid&id2=$row[0]'>删除</a></td>";
                                                echo "</tr>";
                                                $i++;
                                            }
                                            echo "</table>";
        ...
        $sql="select position,education,direction,past_evaluation,desc_achive,desc_teach_type,desc_publish,desc_honor,desc_more from teacher where tid='{$tid}'";
        ...
        if(!$result){
            ...
            echo "<div class='panel panel-default'>";
                echo "<div class='panel-heading'>";
                    echo "<a class='panel-title' data-toggle='collapse' data-parent='#panel-60398' href='#panel-element-233333'>查看详情</a>";
                echo "</div>";
                echo "<div id='panel-element-233333' class='panel-collapse collapse'>";
                    echo "<div class='panel-body'>";
                        if($result->num_rows>0){
                            echo "<table class='table table-hover'>";
                            while($row =$result->fetch_array()){
                                echo "<tr><td>职称</td><td>$row[0]</td></tr>";
                                echo "<tr><td>学历</td><td>$row[1]</td></tr>";
                                echo "<tr><td>研究方向</td><td>$row[2]</td></tr>";
                                echo "<tr><td>教学质量评价</td><td>$row[3]</td></tr>";
                                echo "<tr><td>教学科研成果</td><td>$row[4]</td></tr>";
                                echo "<tr><td>教学风格</td><td>$row[5]</td></tr>";
                                echo "<tr><td>出版书籍</td><td>$row[6]</td></tr>";
                                echo "<tr><td>所获荣誉</td><td>$row[7]</td></tr>";
                                echo "<tr><td>教师寄语</td><td>$row[8]</td></tr>";
                            }
                            echo "</table>";
                        }
                    echo "</div>";
