...
<body>
    <?php
        ...
        $sql="select sid,name,gender,college,major,email,phone,verified_email,verified_phone from student natural join student_info where $option like '%{$keyword}%'";
                ...
                echo "<div class='row clearfix'>";
                    echo "<div class='col-md-12 column'>";
                        ...
                        if($result->num_rows>0){
                            ...
                            echo "<tr><td>编号</td><td>学生姓名</td><td>性别</td><td>学院</td><td>专业</td><td>邮箱</td><td>手机</td><td>邮箱验证</td><td>手机验证</td><td>操作</td></tr>";
                            $i=1;
                            while($row =$result->fetch_array()){
                                ...
                                echo "<td>$row[7]</td>";
                                echo "<td>$row[8]</td>";
                                echo "<td><a href='admin_student_detail.php?id1=$row[0]'>已选课程</a> <a href='admin_student_delete.php?id1=$row[0]'>删除</a></td>";
                                echo "</tr>";
                                $i++;
                            }
                            echo "</table>";
