    ...
    <div class="container">
        ...
        <div class="row clearfix">
            <div class="col-md-4 column">
                <form method="post" action="admin_course_modify1.php" role="form">
                    <div class="form-group">
                        <select name="option" class="form-control">
                            <option value="coname" selected="selected">课程名称</option>
                            <option value="textbook">教材</option>
                            <option value="cocode">课程代码</option>
                            <option value="cotype">课程类型</option>
                            <option value="semster">学期 </option>
                            <option value="coname_en">英文名称</option>
                            <option value="college">开课学院</option>
                            <option value="credit">学分</option>
                            <option value="week_learn_time">周学时</option>
                            <option value="weight">权重</option>
                            <option value="pre_learning">预修要求</option>
                            <option value="plan">教学计划</option>
                            <option value="background">课程背景</option>
                            <option value="assessment">课程评价</option>
                            <option value="project_info">作业信息</option>
                        </select>
                    </div>
                    <div class="form-group"><input type="text" class="form-control" name="content"></div>
